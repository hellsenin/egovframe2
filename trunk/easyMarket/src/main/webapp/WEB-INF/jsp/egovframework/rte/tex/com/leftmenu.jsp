	...
	<fieldset>
		<ul>
			<c:if test="${not empty loginVO}">
				...
				<li><span class="btn_blue"><a href="<c:url value='/mbr/updateMemberView.do'/>"><spring:message code="login.msg.mypage" /></a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" style="margin-left:6px;" /></span>
				<span class="btn_blue"><a href="<c:url value='/j_spring_security_logout'/>"><spring:message code="login.msg.logout" /></a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" style="margin-left:6px;" /></span></li>
			</c:if>
			<c:if test="${empty loginVO}">
				<li><spring:message code="login.msg.login" /></li>
				<li><span class="btn_blue"><a href="<c:url value='/mbr/loginView.do'/>"><spring:message code="mbr.login" /></a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" style="margin-left:6px;" /></span>
				<span class="btn_blue"><a href="<c:url value='/mbr/insertMemberView.do'/>"><spring:message code="mbr.register" /></a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" style="margin-left:6px;" /></span></li>
			</c:if>
		</ul>
	</fieldset>
</div>
